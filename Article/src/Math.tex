...
The input of the algorithm is the vehicle, \vel, the route that vehicle is traversing, \route, the map, $\map = (V, E, C)$ and the maximum distance we want to look into the future. \distmax=2.000 meters as default. %TODO: Check max dist
