...
%TODO: Do we need this paragraph, and where does it go?
...
\tmax is in the following simuations set to 400 seconds, about $6.6$ minuts. %TODO: Check
...
%TODO: What is phase starts and ends with green? Algorithm, no work!
