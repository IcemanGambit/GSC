...
\ncirc in line~\ref{alg:getSpans:ncirc} is the number of times that the signal has made a full circulation.% based on the number of seconds passed since the begining of the simulation and the circulation time of the phase, \Ccirc{\phase}.
