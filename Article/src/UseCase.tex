...
Initially, we will focus on the tests with a spawn rate of $1.0$ vehicle per second. %TODO:  check this 1.0
...
All values are based on common knowledge and the GPS trajectories from "Spar På Farten".%TODO: IMPORTANT: what do we base this on?????
