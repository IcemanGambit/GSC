...
A connection is also associated a traffic light phase, $\cphase$. A full connection network for Figure \ref{fig:Introduction:network} can be seen in Figure \ref{fig:Model:Connection}.
\begin{table}[h]
\centering
\begin{tabular}{|l|c|c|}
\hline
