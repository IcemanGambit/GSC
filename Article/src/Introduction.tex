...
The system we propose, is designed with the assumption that very few vehicle will be using it initialy. 
...
%TODO: Assumptions
% We have a network of roads that follow the model
% We have access to traffic light data
% All vehicles have a route
% All drivers follow the rules of traffic
% More?
