...
if not traci.isEmbedded():
    ...
    sumoBinary = 'sumo-gui' #checkBinary('sumo')
...
while step == 0 or traci.simulation.getMinExpectedNumber() > 0:
	...
	traci.trafficlights.setRedYellowGreenState("0", "gggg")
	traci.vehicle.setMaxSpeed("1", 5.0)
	print traci.vehicle.getRoadID("1") 
